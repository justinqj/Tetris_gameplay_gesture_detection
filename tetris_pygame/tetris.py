...
class Text:
    ...
    def draw(self):
        self.font.render_to(self.app.screen, (WIN_W * 0.32, WIN_H * 0.02),
                            text='TETRIS', fgcolor=self.get_color(),
                            size=TILE_SIZE * 1.65)
        self.font.render_to(self.app.screen, (WIN_W * 0.32, WIN_H * 0.22),
                            text='next', fgcolor='orange',
                            size=TILE_SIZE * 1.4)
        self.font.render_to(self.app.screen, (WIN_W * 0.32, WIN_H * 0.65),
                            text='score', fgcolor='orange',
                            size=TILE_SIZE * 1.4)
        self.font.render_to(self.app.screen, (WIN_W * 0.34, WIN_H * 0.85),
...
#Import Camera and show on screen
class CamView:
    def __init__(self,app):
        self.app = app
        ...
        self.cam = pygame.camera.Camera(self.clist[0], self.camsize)
        self.cam.start()
    ...
    def draw_camera(self):
        ...
        self.app.screen.blit(self.img, (WIN_W * 0.52, WIN_H * 0.22))
